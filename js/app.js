...
function resetApp() {
    ...
    updateProgressBar();
    exitFocusMode(); // Removed closeNav()
}
...
function displayAzkar(index) {
    ...
    updateProgressBar();
    // Removed populateSideNav() from here as side nav is removed
}
...
function startAzkarSession(type) {
    ...
    displayAzkar(azkarIndex);
    updateProgressBar();
    // Removed populateSideNav() from here
}
...
// Side Navigation functions (REMOVED as per new index.html)
