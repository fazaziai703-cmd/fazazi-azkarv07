...
const morningAzkar = [
  {
    ...
    source: "رواه النسائي",
    hadith_number: "لا يوجد رقم حديث محدد في النسخة الأصلية للنسائي، يُعرف بالحديث في فضائل آية الكرسي."
  },
  {
  ...
  },
  {
    ...
    repeat: 1,
    meaning: "يقر المسلم بأن ملك الكون كله لله تعالى في هذا الصباح، ويثني عليه بالحمد، ويسأل خير اليوم وما بعده من أيام، ويستعيذ به من شر هذا اليوم وما بعده، ومن الكسل، ومن كبر السن، ومن عذاب النار والقبر.",
  ...
  {
    text: "أذكار الصباح\\n\\nاللَّهُمَّ أَنْتَ رَبِّي لَا إِلَهَ إِلَّا أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوذُ بِكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوءُ لَكَ بِذَنْبِي فَاغْفِرْ لِي فَإِنَّهُ لَا يَغْفِرُ الذُّنُوبَ إِلَّا أَنْتَ.",
    repeat: 1,
  ...
  },
  {
    ...
    source: "رواه الحاكم وصححه الذهبي",
    hadith_number: "1/545"
  },
  {
  ...
  },
  {
    ...
    repeat: 100,
    meaning: "تسبيح لله تعالى وتنزيه له عن كل نقص، مع الاعتراف له بجميع المحامد، وهو من أحب الأذكار إلى الله تعالى.",
    virtue: "فضلها: من قالها مائة مرة حين يصبح وحين يمسي لم يأت أحد يوم القيامة بأفضل مما جاء به، إلا أحد قال مثل ما قال أو زاد عليه.",
    source: "رواه مسلم",
    hadith_number: "2692"
  }
];
...
const eveningAzkar = [
  ...
  {
    text: "أذكار المساء\\n\\nاللَّهُمَّ أَنْتَ رَبِّي لَا إِلَهَ إِلَّا أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوذُ بِكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوءُ لَكَ بِذَنْبِي فَاغْفِرْ لِي فَإِنَّهُ لَا يَغْفِرُ الذُّنُوبَ إِلَّا أَنْتَ.",
    repeat: 1,
    meaning: "يُعرف هذا الذكر بـ 'سيد الاستغفار'، وفيه يقر المسلم بتوحيد الله وربوبيته، وبأنه خلقه وهو عبده، وأنه يسعى جاهدًا للوفاء بعهد الله ووعده ما استطاع، ويستعيذ بالله من شر أعماله، ويعترف بإنعام الله عليه وبذنوبه، ويطلب المغفرة من الله وحده.",
    virtue: "فضلها: سيد الاستغفار، من قاله موقناً به حين يصبح فمات من يومه دخل الجنة، ومن قاله موقناً به حين يمسي فمات من ليلته دخل الجنة.",
    source: "رواه البخاري",
  ...
  {
    text: "أذكار المساء\\n\\nأَمْسَيْنَا عَلَى فِطْرَةِ الْإِسْلَامِ وَكَلِمَةِ الْإِخْلَاصِ وَعَلَى دِينِ نَبِيِّنَا مُحَمَّدٍ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ وَعَلَى مِلَّةِ أَبِينَا إِبْرَاهِيمَ حَنِيفًا مُسْلِمًا وَمَا كَانَ مِنَ الْمُشْرِكِينَ.",
    repeat: 1,
    meaning: "يجدد المسلم في هذا الذكر عهد إسلامه، وإخلاص توحيده لله، وتمسكه بدين النبي محمد صلى الله عليه وسلم، وملة أبيه إبراهيم عليه السلام التي هي الحنيفية السمحة، براءً من الشرك وأهله.",
    virtue: "تأكيد على الثبات على الإسلام والتوحيد والسنة، واعتزاز بالدين.",
    source: "رواه أحمد",
  ...
  },
  {
    ...
    hadith_number: "البخاري: 6405، مسلم: 2691"
  },
  {
    ...
    source: "رواه البخاري ومسلم",
    hadith_number: "البخاري: 6403، مسلم: 2691"
  }, // أذكار إضافية (أمثلة)
  {
...
const sleepAzkar = [
  {
    ...
    source: "رواه البخاري ومسلم",
    hadith_number: "البخاري: 6320، مسلم: 2714"
  },
  {
  ...
  },
  {
    ...
    source: "رواه البخاري ومسلم",
    hadith_number: "البخاري: 5362، مسلم: 2727"
  },
  {
    ...
    source: "رواه البخاري ومسلم",
    hadith_number: "البخاري: 6311، مسلم: 2710"
  },
  {
  ...
  },
  {
    ...
    source: "رواه البخاري ومسلم",
    hadith_number: "البخاري: 6324، مسلم: 2711"
  },
  {
    text: "أذكار النوم\\n\\nيَجْمَعُ كَفَّيْهِ ثُمَّ يَنْفُثُ فِيهِمَا فَيَقْرَأُ فِيهِمَا قُلْ هُوَ اللَّهُ أَحَدٌ وَقُلْ أَعُوذُ بِرَبِّ الْفَلَقِ وَقُلْ أَعُوذُ بِرَبِّ النَّاسِ ثُمَّ يَمْسَحُ بِهِمَا مَا اسْتَطَاعَ مِنْ جَسَدِهِ، يَبْدَأُ بِهِمَا عَلَى رَأْسِهِ وَوَجْهِهِ وَمَا أَقْبَلَ مِنْ جَسَدِهِ، يَفْعَلُ ذَلِكَ ثَلَاثَ مَرَّاتٍ.",
    repeat: 1,
...
const wakingAzkar = [
  ...
  {
    text: "أذكار الاستيقاظ\\n\\nأَصْبَحْنَا عَلَى فِطْرَةِ الْإِسْلَامِ وَكَلِمَةِ الْإِخْلَاصِ وَعَلَى دِينِ نَبِيِّنَا مُحَمَّدٍ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ وَعَلَى مِلَّةِ أَبِينَا إِبْرَاهِيمَ حَنِيفًا مُسْلِمًا وَمَا كَانَ مِنَ الْمُشْرِكِينَ.",
    repeat: 1,
...
const afterPrayerAzkar = [
  ...
  },
  {
    ...
    source: "رواه البخاري ومسلم",
    hadith_number: "البخاري: 6615، مسلم: 593"
  },
  {
...
// --- Focus View functionality start ---
...
const focusContent = focusViewContainer.querySelector('.focus-content');
const body = document.body;

/**
 * A simple custom modal function to avoid using alert().
 * This assumes you have the infoShareModal structure in your HTML.
 */
function showCustomModal(title, message, buttonText) {
  const modal = document.getElementById('infoShareModal');
  ...
  modalButtons.innerHTML = `<button class="button btn btn-secondary" onclick="closeModal()">${buttonText}</button>`;
  modal.style.display = 'flex';
}

function closeModal() {
  document.getElementById('infoShareModal').style.display = 'none';
}


/**
 * Populates the focus view container with the current azkar content.
 * This function will now find the content from the active tab.
 */
function populateFocusView() {
  const activeTabContent = document.querySelector('.tab-pane.show.active');
  let contentToDisplay = '';

  // Check if the current active tab is the main 'azkar' tab
  if (activeTabContent && activeTabContent.id === 'mainTab') {
    // Find the div containing the Azkar text
    const azkarTextDiv = activeTabContent.querySelector('.content-card');
    if (azkarTextDiv) {
      contentToDisplay = azkarTextDiv.innerHTML;
    } else {
      // Placeholder content if no specific azkar is loaded
      contentToDisplay = `<div class="content-card">
                            <p>
    ...
    // For other tabs, display a default message
    contentToDisplay = `<div class="content-card">
                          <p>هذه هي شاشة التركيز. يمكنك استخدامها لعرض الأذكار بشكل منفصل.</p>
                          <p>الرجاء العودة إلى تبويب الأذكار لتشغيل هذا الوضع بشكل كامل.</p>
                        </div>`;
  }

  focusContent.innerHTML = contentToDisplay;
}

/**
 * Activates the focus view.
 */
...
/**
 * Exits the focus view.
 */
function exitFocusView() {
  body.classList.remove('focus-mode');
}

// Add event listeners for the focus view buttons
if (enterFocusBtn) {
  enterFocusBtn.addEventListener('click', enterFocusView);
}
if (exitFocusBtn) {
  exitFocusBtn.addEventListener('click', exitFocusView);
}
// --- Focus View functionality end ---

// --- Share App functionality from your doc ---
    ...
    shareAppBtn.addEventListener('click', async () => {
      ...
      try {
        if (navigator.share) {
          ...
          showCustomModal('تم نسخ رابط التطبيق', 'تم نسخ رابط التطبيق إلى الحافظة! يمكنك الآن مشاركته.', 'إغلاق');
          console.log('App URL copied to clipboard:', shareData.url);
        }
      } catch (err) {
        console.error('Error sharing the app:', err);
        showCustomModal('فشل المشاركة', 'تعذر مشاركة التطبيق. الرجاء المحاولة مرة أخرى.', 'إغلاق');
      }
    });
  }
});
